...
class TestRegenerateFailingTiles:
    def test_regenerates_only_failing_tiles(self, tmp_path: Path) -> None:
        ...
        review = SheetReviewResult(
            ...
            passed=False, total=30.0, max_score=50.0,
        ...
        best_score, iterations, history = regenerate_failing_tiles(
            review, entries, sheet, tmp_path,
            regenerate_fn=regen_fn, max_iterations=2,
        )
