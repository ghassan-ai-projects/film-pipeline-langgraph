...
5. [03 — target architecture](03-target-architecture.md), [04 — extraction roadmap](04-extraction-roadmap.md), and [05 — enforcement](05-enforcement-and-guard-tests.md): the requested migration target and historical sequencing proposals. Apply each boundary against current source and the live quality gates; their stale counts and behavior-changing clauses are not automatic instructions.
