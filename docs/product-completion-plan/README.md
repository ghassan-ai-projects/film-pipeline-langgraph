...
It is intentionally different from [`docs/product-completion/`](../product-completion/):

- `docs/product-completion/` defines the hard standard for what "done" means
- `docs/product-completion-plan/` defines the phased work to get there
...
- the hard standard in [`docs/product-completion/`](../product-completion/) is satisfied
