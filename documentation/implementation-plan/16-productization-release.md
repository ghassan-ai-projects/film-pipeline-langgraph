...
- [ ] `documentation/operations-guide.md` — operator workflow from project creation to delivery
- [ ] `documentation/runbook-first-film.md` — first real film runbook
- [ ] `documentation/release-process.md` — release checklist, tagging, rollback, hotfix flow
- [ ] `documentation/demo-guide.md` — how to demo the product safely
- [ ] `documentation/acceptance-checklist.md` — final consolidated product acceptance checklist
...
- [ ] Copy the top-level ship checklist into `documentation/acceptance-checklist.md`
