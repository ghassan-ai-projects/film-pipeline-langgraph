...
- Layout facts live in :mod:`film_pipeline.storage._layout`, which is private
  to this package.
...
class ProjectStorage:
    ...
    Construct from the :class:`~film_pipeline.storage.store.ArtifactStore`
    ...
    def read_manifest(self, project_id: str) -> Any:
        ...
        from film_pipeline.storage.manifest import AssetManifest
