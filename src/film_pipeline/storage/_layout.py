...
the files inside a project directory. Nothing outside ``film_pipeline.storage``
should import it: consumers go through
:class:`~film_pipeline.storage.project_storage.ProjectStorage`, which returns
...
from film_pipeline.storage.serialization import atomic_write_text
